 ...
 * @description
 */
public class BDA0710010 extends Swsxtzs{
	private static Log log = LogFactory.getLog(BDA0710010.class);
	...
	public void createPdf(InputStream inputXml, String pdfPath, String signedPdfPath, SignatureVO signatureVO) {
		try {
			...
			if(signatureVO != null){
				float sigBottomY = this.getSigBottomY(document, div.getYLine(), 150, 110);
