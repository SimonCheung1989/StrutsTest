 ...
 * @description
 */
public class BDA0210092 extends Swsxtzs{
	private static Log log = LogFactory.getLog(BDA0210092.class);
	...
	public void createPdf(InputStream inputXml, String pdfPath, String signedPdfPath, SignatureVO signatureVO) {
		try {
			...
			if(signatureVO != null){
				...
				signatureVO.setSignatureRectangle(new Rectangle(130, sigBottomY, 240, sigBottomY+110));
