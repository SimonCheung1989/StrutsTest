 ...
 * @description
 */
public class BDA1320012 extends Swsxtzs{
	private static Log log = LogFactory.getLog(BDA1320012.class);
	...
	public void createPdf(InputStream inputXml, String pdfPath, String signedPdfPath, SignatureVO signatureVO) {
		try {
			...
			if(signatureVO != null){
				...
				signatureVO.setSignatureRectangle(new Rectangle(270, sigBottomY, 380, sigBottomY+110));
